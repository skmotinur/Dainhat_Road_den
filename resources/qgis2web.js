...
map.getView().fit([9805943.773786, 2701071.770280, 9827354.457076, 2712040.358030], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ROAD DENSITY</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (804 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Road density is a measure of the total length of roads within a specific area, usually expressed in kilometers of road per square kilometer of land (km/km²). Road Density = Total length of roads (km) / Total area (km²) <br />When visualizing road density on a map, a high value is often represented in deep red, which means the area has a dense and well-connected road network, typically found in cities or industrial regions. This indicates strong infrastructure, better accessibility, and greater ease of transportation. On the other hand, a low value shown in light yellow signifies a sparse road network, commonly seen in rural, remote, or forested areas. This reflects limited connectivity and possibly underdeveloped infrastructure, which can pose challenges for transportation and regional development.';
            }

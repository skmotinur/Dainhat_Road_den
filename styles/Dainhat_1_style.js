...
var style_Dainhat_1 = function(feature, resolution){
    ...
    var value = feature.get("RD_DENSITY");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.037969 && value <= 0.074929) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.074929 && value <= 0.161087) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.161087 && value <= 0.355215) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.355215 && value <= 1.042669) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.042669 && value <= 1.363542) {
            style = [ new ol.style.Style({
